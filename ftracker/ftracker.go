...
`
	...
	case trainingType == "Бег":
		...
		return fmt.Sprintf(msg, trainingType, duration, distance, speed, calories)
...
func RunningSpentCalories(action int, weight, duration float64) float64 {
	...
	return (runningCaloriesMeanSpeedMultiplier * speedInKmh * runningCaloriesMeanSpeedShift) *
...
func WalkingSpentCalories(action int, duration, weight, height float64) float64 {
	...
	return (walkingCaloriesWeightMultiplier*weight + (math.Pow(speedInMsec, 2.0)/(height/cmInM))*
...
func SwimmingSpentCalories(lenghtPool, countPool int, duration, weight float64) float64 {
	speedInKmh := swimmingMeanSpeed(lenghtPool, countPool, duration)
	return (speedInKmh + swimmingCaloriesMeanSpeedShift) * swimmingCaloriesWeightMultiplier * weight * duration
}
